...
상품은 두 등급이다. 기준·허용·금지·프롬프트는 [`docs/quality-standards.md`](docs/quality-standards.md).
...
두 등급을 가르는 원칙 하나: **미화는 피부·조명·정돈을 바꾸고, 골격·비율은
어느 등급에서도 안 바꾼다.** 사진관이 하는 일이 정확히 그것이다.
